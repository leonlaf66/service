...
export default async (d, { includeRawValue }, ctx) => {
  ...
  if (d.area_id === 'ma') {
    ...
    return await mlsDetail(house, rules, referenceFields, ctx, { includeRawValue })
  }
  
  return await listhubDetail(house, rules, ctx, { includeRawValue })
}
